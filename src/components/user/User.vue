<template>
  <div>
    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="7">
          <el-input placeholder="请输入内容" clearable v-model="queryInfo.query" @input="watcherInput">
    ...
    <el-dialog title="添加用户" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
      <el-form :model="addUserForm" label-width="100px" :rules="userFormRules" ref="addUserFormRef">
  ...
  methods: {
    ...
    addUser() {
      ...
      this.$refs.addUserFormRef.validate(async valid => {
        ...
        // 表单预校验失败
        if (!valid) return
        await this.$http.post('users', this.addUserForm).then(res => {
